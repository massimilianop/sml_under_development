...
class DIController(double_integrator_controller.DoubleIntegratorController): 
    ...
    @classmethod
    def description(cls):
        return "Double integrator controller ..."
    ...
    def parameters_to_string(cls,   \
        ...
        derivative_gain       = 1.0, \
        saturation_position   = 1.0, \
        saturation_velocity   = 1.0):

        dic = {'proportional_gain':proportional_gain ,\
        'derivative_gain'     :derivative_gain       ,\
        'saturation_position' :saturation_position   ,\
    ...
    def __init__(self              , \
        ...
        self.__saturation_position  = saturation_position
        self.__saturation_velocity  = saturation_velocity
    ...
    def  _DI_Bounded(self,p,v):
        ...
        sigma_p  = self.__saturation_position
        sigma_v  = self.__saturation_velocity
