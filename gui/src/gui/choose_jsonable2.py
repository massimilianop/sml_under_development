...
class ChooseJsonablePlugin(Plugin):
    ...
    def __reset_jsonable_widget(self):
        ...
        self.__remove_tabs()
        self._widget.labelJsonableAvailable.setText('Available')
    ...
    def __print_jsonable_description(self):
        ...
        text_label = self._widget.labelJsonableAvailable.text()

        if not text_label=='Available Methods':
    ...
    def __jsonable_item_clicked(self):
        ...
        if text_label=='Available Methods':
            # double clicking on method is the same as clicking once
            self.__print_jsonable_description()

        else:
            # when double clicking on class, it means that class has been selected
    ...
    def __service_jsonable_object(self):
        ...
        if self.__head_class_completed == True:
            ...
            if not text_label=='Available Methods':
                ...
                #can now make methods available since class has been chosen 
                # make it possible to chose methods of class
                self._widget.labelJsonableAvailable.setText('Available Methods')
