...
void GazeboMotorModel::UpdateForcesAndMoments() {
  ...
  // gzerr << "Motor speed is " << motor_rot_vel_ << ".\n";
  double real_motor_velocity = motor_rot_vel_ * rotor_velocity_slowdown_sim_;
  // gzerr << "Real motor speed is " << real_motor_velocity << ".\n";
  ...
  // gzerr << "drag_torque_parent_frame is " << drag_torque_parent_frame << ".\n";
